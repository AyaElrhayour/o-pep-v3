...
//   header("Location: http://localhost/o-pep-v3/.php");
// }
    ...
    <div class="popup-container">
      ...
      <?php   
        ...
        <div class="check-out">
          ...
          <form method="post" action="./app/controllers/ADD_DEL_cart.php">
      ...
      <div class="product__container grid">
        ...
        ?>
          <article class="product__card">
            ...
            <form action="./app/controllers/ADD_DEL_cart.php" method="post">
